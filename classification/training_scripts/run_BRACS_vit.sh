...
# train
python main.py --device ${DEVICE_ID} --thread ${N_THREADS} --loss ${LOSS} --model ${FEATURE_EXACTOR} --config configs/${TASK}.yml --exp $EXP_DIR/${MODEL_VERSION_DIR} --doc ${TASK} --n_splits ${N_SPLITS} #--resume_training                       
